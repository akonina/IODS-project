...
# Tabset {.tabset .tabset-fade .tabset-pills} ## Data exploration
...
1. Calculate the correlation matrix and round it
cor_matrix <- cor(Boston) 
cor_matrix_r <- cor_matrix %>% round(2)  <- до двух цифр после запятой
